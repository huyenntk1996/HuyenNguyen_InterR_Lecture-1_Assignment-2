...
file.exists(params$data_file)
file.exists(params$metadata_file)
...
counts <- read.delim("C:/R/14. Inter  R/HuyenNguyen_InterR_lecture 1_Assignment 2/HuyenNguyen_InterR_Lecture-1_Assignment-2/counts.txt", header=TRUE)
metadata <- read.delim("C:/R/14. Inter  R/HuyenNguyen_InterR_lecture 1_Assignment 2/HuyenNguyen_InterR_Lecture-1_Assignment-2/metadata.txt")
